 ...
 * libplacebo D3D11: via MPV_RENDER_API_TYPE_PL_D3D11, see render_d3d11.h header.
 * libplacebo Vulkan: via MPV_RENDER_API_TYPE_PL_VULKAN, see render_vulkan.h header.
...
typedef enum mpv_color_primaries {
    ...
    MPV_COLOR_PRIMARIES_BT_601_525  = 1,
    MPV_COLOR_PRIMARIES_BT_601_625  = 2,
    MPV_COLOR_PRIMARIES_BT_709      = 3,
    MPV_COLOR_PRIMARIES_BT_470M     = 4,
    MPV_COLOR_PRIMARIES_EBU_3213    = 5,
    MPV_COLOR_PRIMARIES_BT_2020     = 6,
    MPV_COLOR_PRIMARIES_APPLE       = 7,
    MPV_COLOR_PRIMARIES_ADOBE       = 8,
    MPV_COLOR_PRIMARIES_PRO_PHOTO   = 9,
    MPV_COLOR_PRIMARIES_CIE_1931    = 10,
    MPV_COLOR_PRIMARIES_DCI_P3      = 11,
    MPV_COLOR_PRIMARIES_DISPLAY_P3  = 12,
    MPV_COLOR_PRIMARIES_V_GAMUT     = 13,
    MPV_COLOR_PRIMARIES_S_GAMUT     = 14,
    MPV_COLOR_PRIMARIES_FILM_C      = 15,
    MPV_COLOR_PRIMARIES_ACES_AP0    = 16,
    MPV_COLOR_PRIMARIES_ACES_AP1    = 17,
} mpv_color_primaries;
...
typedef enum mpv_color_transfer {
    ...
    MPV_COLOR_TRANSFER_BT_1886      = 1,
    MPV_COLOR_TRANSFER_SRGB         = 2,
    MPV_COLOR_TRANSFER_LINEAR       = 3,
    MPV_COLOR_TRANSFER_GAMMA18      = 4,
    MPV_COLOR_TRANSFER_GAMMA20      = 5,
    MPV_COLOR_TRANSFER_GAMMA22      = 6,
    MPV_COLOR_TRANSFER_GAMMA24      = 7,
    MPV_COLOR_TRANSFER_GAMMA26      = 8,
    MPV_COLOR_TRANSFER_GAMMA28      = 9,
    MPV_COLOR_TRANSFER_PRO_PHOTO    = 10,
    MPV_COLOR_TRANSFER_ST428        = 11,
    MPV_COLOR_TRANSFER_PQ           = 12,
    MPV_COLOR_TRANSFER_HLG          = 13,
    MPV_COLOR_TRANSFER_V_LOG        = 14,
    MPV_COLOR_TRANSFER_S_LOG1       = 15,
    MPV_COLOR_TRANSFER_S_LOG2       = 16,
} mpv_color_transfer;
